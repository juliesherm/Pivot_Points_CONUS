...
do
	...
	do
        ...
        echo $vi
        gdalbuildvrt ${vi}_${wb}_pval_CONUS.vrt -input_file_list ${vi}_${wb}_piv_files.txt -b 5
        gdal_translate ${vi}_${wb}_pval_CONUS.vrt ${vi}_${wb}_pval.tif -co TILED=YES -co COMPRESS=LZW -co COPY_SRC_OVERVIEWS=YES -co BIGTIFF=YES
